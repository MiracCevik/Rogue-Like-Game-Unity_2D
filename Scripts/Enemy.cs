...
public class Enemies : NetworkBehaviour
{
    ...
    void Awake()
    {
        // Çevrimdýþý modda düþmaný baþlat
    ...
    void Start()
    {
        // Oyuncuyu bul ve referanslarý ayarla
        ...
        if (player != null)
        {
            ...
            if (karakterRef == null)
            {
                Debug.LogWarning("KarakterHareket bileþeni bulunamadý!");
            }
        }
        else
        {
    ...
    private void InitializeEnemy()
    {
        if (enemyStats == null)
        {
            Debug.LogWarning("EnemyStats atanmadý, varsayýlan deðerler kullanýlýyor.");
    ...
    void UpdateHealthBar()
    {
        if (greenHealthBar != null && redHealthBar != null)
        {
            ...
            Debug.Log("enemy caný  " + currentHealth);
    ...
    void Die()
    {
        ...
        Debug.Log("Karakter Altýný: " + karakterRef.gold);
    ...
    public void SaveEnemyData()
    {
        ...
        {
            Debug.LogError("Kaydedilecek EnemyStats bulunamadý!");
        }
    }
    ...
    void LoadEnemyData()
    {
        ...
        {
            Debug.LogError("Dýþman verisi bulunamadý, varsayýlan deðerler yüklenecek.");
        }
    }
